	...
	function Config() {
			...
			dev: {
				bsFiles: {
                    src : [
                        ...
                        'public/assets/front/img/*.jpg',
                        'public/assets/front/img/*.png',
                        'public/*.html',
                        'public/*.php'
                    ]
                },
		...
		*/
		...
		for ( view in cfg.views ) {
			...
			config.watch[view + 'templates'] = {files: []};
			for ( var tpl in cfg.views[view].templates )
				config.watch[view + 'templates'].files.push(cfg.views[view].templates[tpl]);
		}
